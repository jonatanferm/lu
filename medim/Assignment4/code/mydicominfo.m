...
t(6).name = 'SliceSpacing';         t(6).groupnumber = '0018'; t(6).elementnumber = '0088'; t(6).type = 'num';   t(6).default=0;
...
t(9).name = 'PixelSpacing';         t(9).groupnumber = '0028'; t(9).elementnumber = '0030'; t(9).type = 'num';   t(9).default=0;
t(10).name = 'PixelData';         t(10).groupnumber = '7ef0'; t(10).elementnumber = '0010'; t(10).type = 'uint16';   t(10).default=0;
t(11).name = 'RescaleIntercept';         t(11).groupnumber = '0028'; t(11).elementnumber = '1052'; t(11).type = 'num';   t(11).default=0;
t(12).name = 'BitsStored';         t(12).groupnumber = '0028'; t(12).elementnumber = '0101'; t(12).type = 'uint16';   t(12).default=0;
t(13).name = 'RescaleType';         t(13).groupnumber = '0028'; t(13).elementnumber = '1054'; t(13).type = 'char';   t(13).default='';
t(14).name = 'ScanningSequence';         t(14).groupnumber = '0018'; t(14).elementnumber = '0020'; t(14).type = 'char';   t(14).default='';
t(15).name = 'SequenceVariant';         t(15).groupnumber = '0018'; t(15).elementnumber = '0021'; t(15).type = 'char';   t(15).default='';
t(16).name = 'RepetitionTime';         t(16).groupnumber = '0018'; t(16).elementnumber = '0080'; t(16).type = 'num';   t(16).default='';
t(17).name = 'EchoTime';         t(17).groupnumber = '0018'; t(17).elementnumber = '0081'; t(17).type = 'num';   t(17).default='';
